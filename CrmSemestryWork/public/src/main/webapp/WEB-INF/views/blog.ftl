        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="/blog">Микроблог</a></li>
        ...
        <div class="row">
            <aside class="col-sm-4 col-sm-push-8">
                ...
                <div class="widget ads">
                    <div class="row">
                        <div class="col-xs-6">
                            <a href="#"><img class="img-responsive img-rounded" src="/resources/images/ads/ad1.png" alt=""></a>
                        </div>

                        <div class="col-xs-6">
                            <a href="#"><img class="img-responsive img-rounded" src="/resources/images/ads/ad2.png" alt=""></a>
                        </div>
                    </div>
                    <p> </p>
                    <div class="row">
                        <div class="col-xs-6">
                            <a href="#"><img class="img-responsive img-rounded" src="/resources/images/ads/ad3.png" alt=""></a>
                        </div>

                        <div class="col-xs-6">
                            <a href="#"><img class="img-responsive img-rounded" src="/resources/images/ads/ad4.png" alt=""></a>
                        </div>
                    </div>
                </div><!--/.ads-->     
            ...
            <div class="col-sm-8 col-sm-pull-4">
                <div class="blog">
                    <div class="blog-item">
                        <img class="img-responsive img-blog" src="/resources/images/blog/blog1.jpg" width="100%" alt="" />
                    ...
                    <div class="blog-item">
                        <img class="img-responsive img-blog" src="/resources/images/blog/blog2.jpg" width="100%" alt="" />
                        <div class="blog-content">
