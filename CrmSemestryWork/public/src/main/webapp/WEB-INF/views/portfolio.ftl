    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="active"><a href="/portfolio">Наши предложения</a></li>
                <li><a href="/career">Карьера в нашей компании</a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Получить доступ <i
...
<section id="portfolio" class="container">
    ...
    <#if category??>
        <#list category as c>
            <li><a class="btn btn-default" href="#" data-filter=".${c.name}">${c.name}</a></li>
        </#list>
    </#if>
...
<#if good??>
    <#list good as g>
        <ul class="portfolio-items col-3">
            <li class="portfolio-item крым">
                <div class="item-inner">
                    <img src="/resources/images/portfolio/thumb/item1.jpg" alt="">
                    <h5>${g.name}</h5>
                ...
                <#--<#if (Session.cart.goods)?? && Session.cart.containsGoodId(good.id)>
                    <a class="preview btn btn-danger" href="/cart" rel="prettyPhoto"><i
                            class="icon-bookmark" </i></a>
                <#else>-->
                    <a class="button item_add cbp-vm-icon cbp-vm-add js_addToCart" data-id="${g.id}" href="/cart"><i
                            class="icon-book" </i></a>
                <#--</#if>-->
                <#--</div>-->
                </div>
