...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" href="i/resources/mages/ico/apple-touch-icon-57-precomposed.png">
</head><!--/head-->
<body>
    ...
    <section id="about-us" class="container">
        ...
        <div id="meet-the-team" class="row">
            <div class="col-md-3 col-xs-6">
                <div class="center">
                    <p><img class="img-responsive img-thumbnail img-circle" src="/resources/images/team-member.jpg" alt="" ></p>
